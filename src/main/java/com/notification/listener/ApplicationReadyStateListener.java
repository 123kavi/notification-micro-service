...
public class ApplicationReadyStateListener implements ApplicationListener<ApplicationReadyEvent> {
     ...
     * @param singleTemplateFormatDto : com.cl.notification.dto.request.SingleEmailTemplateFormatDto
    ...
    /**
     * @param jobId : java.lang.String
     * @param multiTemplateFormatDto : com.cl.notification.dto.request.MultiEmailTemplateFormatDto
    ...
    /**
     * @param schedulerDetails : java.util.List<com.cl.notification.entity.EmailSchedulerDetail>
     * @return java.util.List<com.cl.notification.dto.request.SingleEmailTemplateRequestDto>
