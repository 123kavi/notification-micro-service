...
//
//
//import com.cloudofgoods.notification.dto.ScheduleEmailRequestDTO;
//import com.cloudofgoods.notification.dto.request.MailRequestDto;
//import com.cloudofgoods.notification.entity.ScheduleEmailRequest;
//import com.cloudofgoods.notification.entity.ScheduleEmailResponse;
...
//
//            List<ScheduleEmailRequest> scheduleEmailRequests = scheduleEmailRequestRepository.findAllByDateTimeGreaterThanEqualAndIsActiveEquals(now, true);
//
...
//        ZonedDateTime zonedDateTime = startAt.atZone(zoneId);
//        Instant instant = zonedDateTime.toInstant();
//        Date date = Date.from(instant);
//        return TriggerBuilder.newTrigger().forJob(jobDetail).withIdentity(jobDetail.getKey().getName(), "email-triggers").withDescription("Send Email Trigger").startAt(Date.from(date.toInstant())).withSchedule(SimpleScheduleBuilder.simpleSchedule().withMisfireHandlingInstructionFireNow()).build();
//    }
//}
